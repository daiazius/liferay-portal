 ...
 */
public class GoogleMapsAPIKeyVaultUtilTest {
	...
	public void setUp() throws Exception {
		...
		ReflectionTestUtil.setFieldValue(
			GoogleMapsAPIKeyVaultUtil.class, "_secretManagerSnapshot",
			new Snapshot<SecretManager>(
				GoogleMapsAPIKeyVaultUtil.class, SecretManager.class) {
	...
	public void testVault() throws Exception {
		...
		Assert.assertEquals(
			...
			GoogleMapsAPIKeyVaultUtil.vault(companyId, _IDENTIFIER, value));
	...
	public void testVaultWhenValueReferencesAnotherSlot() throws Exception {
		String value =
			"${secretRef:provider:preference/company/1/googleMapsAPIKey}";
	...
	private static final String _IDENTIFIER =
		"preference/company/2/googleMapsAPIKey";
