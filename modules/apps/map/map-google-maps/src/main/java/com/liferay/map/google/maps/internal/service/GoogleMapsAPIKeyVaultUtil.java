 ...
 */
public class GoogleMapsAPIKeyVaultUtil {

	public static String getCompanyIdentifier(long companyId) {
		return StringBundler.concat(
			_IDENTIFIER_PREFIX, "company/", companyId, StringPool.SLASH, _KEY);
	}

	public static String getGroupIdentifier(long groupId) {
		return StringBundler.concat(
			_IDENTIFIER_PREFIX, "group/", groupId, StringPool.SLASH, _KEY);
	}
	...
	private static final String _KEY = "googleMapsAPIKey";

	private static final Snapshot<SecretManager> _secretManagerSnapshot =
		new Snapshot<>(
			GoogleMapsAPIKeyVaultUtil.class, SecretManager.class, null, true);
